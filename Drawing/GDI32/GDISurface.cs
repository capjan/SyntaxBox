...
namespace Alsing.Drawing.GDI
{
    public class GDISurface : GDIObject
    {
        ...
        internal IntPtr _OldBmp = IntPtr.Zero;
        internal IntPtr _OldBrush = IntPtr.Zero;
        internal IntPtr _OldFont = IntPtr.Zero;
        internal IntPtr _OldPen = IntPtr.Zero;
        internal IntPtr mhBMP;
        internal IntPtr mhDC;
