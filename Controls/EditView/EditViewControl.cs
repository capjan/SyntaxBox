...
namespace Alsing.Windows.Forms.SyntaxBox
{
    ...
    public class EditViewControl : SplitViewChildControl
    {
                            ...
                            Replace(@"
      {
        ...
        {
            this.View = new ViewPoint(EditAction.None);
            _SyntaxBox = Parent;
        ...
        public void InsertAutolistText()
        {
            ...
            AutoListBeforeInsertTextEventArgs e = new AutoListBeforeInsertTextEventArgs(AutoList.SelectedText);
            OnAutoListBeforeInsert(e);
            if (!e.Cancel)
            {
        ...
        private void OnAutoListBeforeInsert(AutoListBeforeInsertTextEventArgs e)
        {
