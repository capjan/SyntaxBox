...
namespace Alsing.Windows.Forms.SyntaxBox
{
    ...
    [ComVisible(false)]
    public class AutoListBeforeInsertTextEventArgs : System.ComponentModel.CancelEventArgs
    {
        public string Text { get; set; }

        #region "Konstruktoren"

        public AutoListBeforeInsertTextEventArgs(string txt)
            : base(false)
        {
            this.Text = txt;
        }
        public AutoListBeforeInsertTextEventArgs(string txt, bool cancel)
            : base(cancel)
        {
            this.Text = txt;
        }
        public AutoListBeforeInsertTextEventArgs()
        {
            this.Text = "";
        }
        public AutoListBeforeInsertTextEventArgs(bool cancel)
            : base(cancel)
        {
            this.Text = "";
        }
