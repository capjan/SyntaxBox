...
namespace Alsing.Windows.Forms
{
    ...
    public class SyntaxBoxControl : SplitViewParentControl
    {
        ...
        protected virtual void OnAutoListBeforeInsertText(object sender, AutoListBeforeInsertTextEventArgs e)
        {
            AutoListBeforeInsertTextHandler handler = AutoListBeforeInsertText;
            if (handler != null)
                handler(sender, e);
        }
        ...
        public void OnWordMouseHover(WordMouseEventArgs e)
        {
            if (WordMouseHover != null)
                WordMouseHover(this, e);
        }

        public void OnWordMouseDown(WordMouseEventArgs e)
        {
            if (WordMouseDown != null)
                WordMouseDown(this, e);
        }
        ...
        private void View_AutolistBeforeInsertText(object sender , AutoListBeforeInsertTextEventArgs e)
        {
